...
/**
 * Created by edgeorge on 26/09/2016.
 */


public class SetImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
    ...
    public SetImageBehavior(Context context, AttributeSet attrs) {
        mContext = context;
